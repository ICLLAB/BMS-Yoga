    ...
    function viewModel(){
        ...
        $.ajax({
          ...
          for (var i=0;i<data.count;i++)
          {
            ...
            $("#datatable tbody").append("<tr> <td class='nr'hidden>"+data.trainer[i]._id+" </td> <td style='padding-left:65px;'> "+(i+1)+"</td><td contenteditable='false' class='sa' style='padding-left:65px;' >"+data.trainer[i].f_name+" </td> <td contenteditable='false' class='mn'style='padding-left:65px;'>"+data.trainer[i].m_name+" </td><td contenteditable='false' class='ln'style='padding-left:75px;'>"+data.trainer[i].l_name+" </td><td contenteditable='false' class='ph'style='padding-left:75px;' >"+data.trainer[i].phone+" </td><td style='padding-left:25px;'>"+data.trainer[i].creation_time+" </td> <td style='padding-left:25px;' >"+data.trainer[i].lastLogin+" </td><td style='padding-left:45px;'><button class='mdl-button mdl-js-button mdl-button--icon mdl-button--colored use'style='padding-left:65px;'><i class='material-icons'>delete</i></button><button class='mdl-button mdl-js-button mdl-button--icon mdl-button--colored'><i class='material-icons editbtn'>edit</i></button></tr>");
